    ...
    <div class="col-md-6">
        <div class="form-container">
            <form autocomplete="off" action="checkout-charge.php" method="POST">
                ...
                data-key="pk_test_51JTMk8CbaEnnmnCRKuxJuJnJkgw5R4ztsIKbrPaanzb31782jKn4yPSP0vwuMsWdevFzpdMZL4oDWRSc8RxIg3Ew0013ghNJbS"
                data-amount="<?php echo $_GET["price"] * 100?>"
                data-name="<?php echo $_GET["item_name"]?> "
                data-description="The best of the best"
